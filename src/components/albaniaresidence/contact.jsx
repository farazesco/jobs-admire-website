...
import enTranslations from '../../../public/locales/en/ContactsSection.json';
import trTranslations from '../../../public/locales/tr/ContactsSection.json';
import frTranslations from '../../../public/locales/fr/ContactsSection.json';
import deTranslations from '../../../public/locales/de/ContactsSection.json';
import arTranslations from '../../../public/locales/ar/ContactsSection.json';
import ruTranslations from '../../../public/locales/ru/ContactsSection.json';
import faTranslations from '../../../public/locales/fa/ContactsSection.json';
...
const ContactsSection = () => {
  ...
  const contacts = [
    {
      id: 1,
      country: t.offices.turkey.country,
      city: t.offices.turkey.city,
      address: t.offices.turkey.address,
      phone: "+90 242 123 4567",
      email: "antalya@uniadmire.com",
      hours: t.offices.turkey.hours,
      icon: Building,
    ...
    {
      id: 2,
      country: t.offices.pakistan.country, 
      city: t.offices.pakistan.city,
      address: t.offices.pakistan.address,
      phone: "+92 21 3456 7890",
      email: "karachi@uniadmire.com", 
      hours: t.offices.pakistan.hours,
      icon: Building,
    ...
    {
      id: 3,
      country: t.offices.azerbaijan.country,
      city: t.offices.azerbaijan.city, 
      address: t.offices.azerbaijan.address,
      phone: "+994 12 345 6789",
      email: "baku@uniadmire.com",
      hours: t.offices.azerbaijan.hours, 
      icon: Building,
