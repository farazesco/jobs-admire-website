...
import enTranslations from '../../../public/locales/en/albania4.json';
import trTranslations from '../../../public/locales/tr/albania4.json';
import frTranslations from '../../../public/locales/fr/albania4.json';
import deTranslations from '../../../public/locales/de/albania4.json';
import arTranslations from '../../../public/locales/ar/albania4.json';
import ruTranslations from '../../../public/locales/ru/albania4.json';
import faTranslations from '../../../public/locales/fa/albania4.json';
...
const AlbaniaResidenceProcess = () => {
  ...
  const images = [
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaeQUWdLVz4bviNrf3bDwMkmwPcASWzvHrwA&s",
      alt: t.images.tirana.alt,
      
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLnMM0tn7EHA_KwJGLtnj6deA82je-eebg4w&s",
      alt: t.images.albanianRiviera.alt,
      
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwcMXte1v8wP6yLOscTH_Ow2NLgM01mpLCSQ&s",
      alt: t.images.historicAlbania.alt,
      
    },
    {
      src: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Leternjoftimi_shqiptar_biometrik...jpg/640px-Leternjoftimi_shqiptar_biometrik...jpg",
      alt: t.images.albanianAlps.alt,
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-white/90 backdrop-blur-lg rounded-xl p-3 shadow-lg border border-white/50">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sky-800 font-semibold text-xs">{t.floatingBadge}</span>
              </div>
            </div>
          </div>
...
export default AlbaniaResidenceProcess;