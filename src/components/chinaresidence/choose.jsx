...
import enTranslations from '../../../public/locales/en/china2.json';
import trTranslations from '../../../public/locales/tr/china2.json';
import frTranslations from '../../../public/locales/fr/china2.json';
import deTranslations from '../../../public/locales/de/china2.json';
import arTranslations from '../../../public/locales/ar/china2.json';
import ruTranslations from '../../../public/locales/ru/china2.json';
import faTranslations from '../../../public/locales/fa/china2.json';
...
const WhyChooseSection = () => {
  ...
  const reasons = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?w=600&h=400&fit=crop&crop=center",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1570227760050-1138de2c7fd5?w=600&h=400&fit=crop&crop=center",
      color: "from-sky-500 via-blue-600 to-sky-700",
      lightColor: "from-sky-100 to-blue-100"
    },
    {
      icon: User,
      title: t.reasons.dedicatedManager.title,
      shortDesc: t.reasons.dedicatedManager.shortDesc,
      fullDesc: t.reasons.dedicatedManager.fullDesc,
      image: "https://images.unsplash.com/photo-1534795748389-555169d2e541?w=600&h=400&fit=crop&crop=center",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1518884016222-7b34b08ad6e7?w=600&h=400&fit=crop&crop=center",
      color: "from-sky-600 via-blue-700 to-sky-800",
      lightColor: "from-sky-100 to-blue-100"
    },
    {
      icon: Award,
      title: t.reasons.highSuccessRate.title,
      shortDesc: t.reasons.highSuccessRate.shortDesc,
      fullDesc: t.reasons.highSuccessRate.fullDesc,
      image: "https://images.unsplash.com/photo-1528181304800-259b08848526?w=600&h=400&fit=crop&crop=center",
      color: "from-sky-500 via-blue-600 to-sky-700",
      lightColor: "from-sky-100 to-blue-100"
    }
  ];
