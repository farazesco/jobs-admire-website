...
import enTranslations from '../../../public/locales/en/china5.json';
import trTranslations from '../../../public/locales/tr/china5.json';
import frTranslations from '../../../public/locales/fr/china5.json';
import deTranslations from '../../../public/locales/de/china5.json';
import arTranslations from '../../../public/locales/ar/china5.json';
import ruTranslations from '../../../public/locales/ru/china5.json';
import faTranslations from '../../../public/locales/fa/china5.json';

const ChinaResidenceProcess = () => {
  ...
  const stages = [
    ...
    {
      icon: FileSearch,
      title: t.stages.documentPreparation.title,
      description: t.stages.documentPreparation.description,
      step: "02"
    },
    {
      icon: Scale,
      title: t.stages.applicationSubmission.title,
      description: t.stages.applicationSubmission.description,
      step: "03"
    },
    {
      icon: CheckCircle,
      title: t.stages.permitApproval.title,
      description: t.stages.permitApproval.description,
      step: "04"
    }
  ];
  ...
  const images = [
    {
      src: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=500&h=400&fit=crop&crop=center",
      alt: t.images.greatWall.alt,
      
    },
    {
      src: "https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?w=500&h=400&fit=crop&crop=center",
      alt: t.images.shanghai.alt,
      
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFK_-yPan6ArWeaVdvt6temegB0QBmcCWmjw&s",
      alt: t.images.forbiddenCity.alt,
      location: t.images.forbiddenCity.location,
      description: t.images.forbiddenCity.description
    },
    {
      src: "https://www.zhaozhao.co/wp-content/uploads/2020/10/Sample-Beijing-Temporary-Residence-Registration-Form.jpg",
      alt: t.images.temple.alt,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-sky-900 leading-tight mb-4">
            {t.header.title.yourStepByStep}{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-blue-600">
              {t.header.title.chinaResidencePermit}
            </span>{' '}
            {t.header.title.success}
          </h2>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-white/90 backdrop-blur-lg rounded-xl p-3 shadow-lg border border-white/50">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sky-800 font-semibold text-xs">{t.floatingBadge.permitsProcessing}</span>
              </div>
            </div>
          </div>
...
export default ChinaResidenceProcess;