...
import enTranslations from '../../../public/locales/en/dubai1.json';
import trTranslations from '../../../public/locales/tr/dubai1.json';
import frTranslations from '../../../public/locales/fr/dubai1.json';
import deTranslations from '../../../public/locales/de/dubai1.json';
import arTranslations from '../../../public/locales/ar/dubai1.json';
import ruTranslations from '../../../public/locales/ru/dubai1.json';
import faTranslations from '../../../public/locales/fa/dubai1.json';

const DubaiResidenceBenefitsSection = () => {
  ...
  const benefits = [
    ...
    {
      icon: Plane,
      title: t.benefits.familySponsorship.title,
      description: t.benefits.familySponsorship.description
    },
    {
      icon: Heart,
      title: t.benefits.goldenVisa.title,
      description: t.benefits.goldenVisa.description
    }
  ];
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-12 border border-white/50 relative overflow-hidden">
            ...
            <div className="w-full h-full bg-gradient-to-br from-sky-500 to-sky-700 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-32 h-32">
                  {/* Horizontal stripes */}
                  <div className="absolute top-4 left-4 right-4 h-2 bg-white"></div>
                  <div className="absolute top-8 left-4 right-4 h-2 bg-white opacity-60"></div>
                  <div className="absolute top-12 left-4 right-4 h-2 bg-white opacity-80"></div>
                  {/* Vertical stripe */}
                  <div className="absolute left-4 top-4 bottom-4 w-3 bg-white opacity-70"></div>
                  {/* Decorative elements */}
                  <div className="absolute right-8 top-8 w-4 h-4 bg-white opacity-50 transform rotate-45"></div>
                  <div className="absolute right-12 top-12 w-3 h-3 bg-white opacity-60 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold text-sky-800 mb-4">
              <span className="text-sky-600">{t.header.benefitsText}</span> {t.header.dubaiResidencePermit}
            </h2>
...
export default DubaiResidenceBenefitsSection;