...
import enTranslations from '../../../public/locales/en/dubai3.json';
import trTranslations from '../../../public/locales/tr/dubai3.json';
import frTranslations from '../../../public/locales/fr/dubai3.json';
import deTranslations from '../../../public/locales/de/dubai3.json';
import arTranslations from '../../../public/locales/ar/dubai3.json';
import ruTranslations from '../../../public/locales/ru/dubai3.json';
import faTranslations from '../../../public/locales/fa/dubai3.json';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border border-white/50 shadow-xl">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-sky-900">{t.generalInquiry.title}</h3>
                  <p className="text-sky-600">{t.generalInquiry.subtitle}</p>
                </div>
              </div>
              <a 
