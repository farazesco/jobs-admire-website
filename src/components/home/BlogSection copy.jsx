...
export default function BlogCarousel() {
  ...
  if (loading) {
    return (
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-slate-50 via-sky-50/30 to-blue-50">
        {/* Animated Background */}
        ...
        <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
          <div className="text-center">
            ...
            <p className="text-slate-600 text-lg">Loading our latest educational insights...</p>
          </div>
        </div>
      </section>
    );
  ...
  if (error) {
    return (
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-red-50 via-rose-50/30 to-pink-50">
        <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-md mx-auto">
            <div className="p-8 text-center bg-white/80 backdrop-blur-sm border border-red-100 rounded-3xl shadow-xl">
              ...
              <h3 className="mb-4 text-2xl font-bold text-slate-800">Unable to Load Content</h3>
  ...
  if (!blogs || blogs.length === 0) {
    return (
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-amber-50 via-yellow-50/30 to-orange-50">
        <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-md mx-auto">
            <div className="p-8 text-center bg-white/80 backdrop-blur-sm border border-amber-100 rounded-3xl shadow-xl">
              ...
              <h3 className="mb-4 text-2xl font-bold text-slate-800">Coming Soon</h3>
              <p className="text-slate-600 leading-relaxed">Amazing blog content is on the way! Check back soon for inspiring educational insights.</p>
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-sky-50/20 to-blue-50/30">
      ...
      <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <div className="mb-16 text-center">
          <div className="inline-flex items-center px-6 py-3 mb-6 rounded-full bg-gradient-to-r from-sky-100 to-blue-100 border border-sky-200/50 shadow-lg backdrop-blur-sm">
            <div className="flex items-center justify-center w-6 h-6 mr-3 rounded-full bg-gradient-to-r from-sky-500 to-blue-600">
              <Sparkles size={14} className="text-white" />
            </div>
            <span className="text-sm font-bold text-transparent bg-gradient-to-r from-sky-700 to-blue-800 bg-clip-text tracking-wide uppercase">
              Featured Content
            </span>
          </div>
          
          <h2 className="mb-6 text-5xl font-bold text-transparent md:text-6xl lg:text-7xl bg-gradient-to-r from-slate-800 via-sky-700 to-blue-600 bg-clip-text leading-tight">
            Educational
            <span className="block text-transparent bg-gradient-to-r from-sky-600 to-blue-500 bg-clip-text">
              Insights
            </span>
          </h2>
          
          <p className="max-w-3xl mx-auto text-xl text-slate-600 leading-relaxed">
            Discover transformative scholarship opportunities, expert career guidance, and cutting-edge educational resources that will accelerate your academic journey
          </p>
        </div>
