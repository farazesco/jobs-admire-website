...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden pt-[186px] xs:pt-[166px] lg:pt-[172px] pb-[50px]">
      ...
      {/* Light beam effect */}
      <div
        className="absolute top-0 right-1/4 w-96 h-screen bg-blue-400 opacity-10 rotate-15 transform -skew-x-12"
      ...
      <div className="container mx-auto h-full px-4 py-8 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 h-5/6 items-center">
          ...
          <div className="text-white z-10 space-y-6 md:pr-8">
          ...
          <div className="flex items-center justify-center z-10 py-8 md:py-0">
            ...
            >
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-150 w-2/5 h-2/5">
                ...
                <div className="absolute -right-10 -bottom-10 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-3 rounded-lg shadow-lg">
