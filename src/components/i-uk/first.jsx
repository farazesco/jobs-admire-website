...
const sectionComponents = {
  ...
  3: SectionOne, // Requirements for Moving to UK
  4: SectionTwo, // Getting a Job in UK as a Foreigner
  5: SectionThree, // Moving to UK from the US
  6: () => (
    <div>
      <Tuk />
    </div>
...
const InteractiveTableOfContents = () => {
  ...
  const LanguageSwitcher = () => {
    const availableLocales = ["en", "tr"]; // Add other locales when you have the files
    const localeNames = {
      en: "English",
      tr: "Türkçe",
      // fr: 'Français',
  ...
  return (
    ...
    >
          ...
          <div className="bg-gradient-to-br from-white via-sky-50 to-white m-4 rounded-2xl overflow-hidden shadow-2xl border border-sky-100 backdrop-blur-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {activeSection === section.id && (
                        ...
                        >
                          ...
                          >
                            {t.tableOfContents.currentlyReading}
                          </div>
                        </div>
                      )}
                    </div>
            ...
            <div className="py-4 px-6 bg-gradient-to-r from-sky-50 to-white border-t border-sky-100">
              ...
              >
                ...
                ></div>
                {t.tableOfContents.sectionsCount.replace(
                  "{{count}}",
                  sections.length
                )}
              </div>
      ...
      <div className={`fixed bottom-6 z-50 ${isRTL ? "left-6" : "right-6"}`}>
        <div className="relative group">
          <button className="bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white p-4 rounded-full shadow-xl transition-all duration-300 transform hover:scale-110 hover:shadow-2xl focus:outline-none border-2 border-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 border border-sky-100 backdrop-blur-sm">
              ...
              >
                ...
                <div className="text-sm font-bold text-sky-700">
                  {t.tableOfContents.quickNavigation}
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-sky-100 text-center">
                <div className="text-xs text-sky-600 font-medium">
                  {t.tableOfContents.scrollText.replace(
                    "{{count}}",
                    sections.length
                  )}
                </div>
