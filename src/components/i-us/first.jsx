// components/InteractiveTableOfContents.jsx
...
const sectionComponents = {
  ...
  3: SectionOne, // Requirements for Moving
  4: SectionTwo, // Getting a Job as a Foreigner
  5: SectionThree, // Moving from another country
  6: () => (
    <div>
      <Tuk />
    </div>
            ...
            >
              {sections.map((section) => (
                <div
                  ...
                  role="button"
                  tabIndex={0}
                  aria-label={t.tableOfContents.accessibility.sectionButton.replace(
                    "{title}",
                    section.title
                  )}
                  onKeyDown={(e) => {
      ...
      <div className={`fixed bottom-6 z-50 ${isRTL ? "left-6" : "right-6"}`}>
        <div className="relative group">
          <button
            ...
            aria-label={t.tableOfContents.accessibility.quickNavigation}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 border border-sky-100 backdrop-blur-sm">
              ...
              >
                ...
                <div className="text-sm font-bold text-sky-700">
                  {t.tableOfContents.quickNavigation.title}
                </div>
              </div>
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {sections.map((section) => (
                  <div
                    ...
                    role="button"
                    tabIndex={0}
                    aria-label={t.tableOfContents.accessibility.quickNavSection.replace(
                      "{title}",
                      section.title
                    )}
                    onKeyDown={(e) => {
              ...
              <div className="mt-4 pt-3 border-t border-sky-100 text-center">
                <div className="text-xs text-sky-600 font-medium">
                  {t.tableOfContents.quickNavigation.footer.replace(
                    "{count}",
                    sections.length
                  )}
                </div>
