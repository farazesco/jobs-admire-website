          ...
          >
            ...
            >
              <button
                ...
                aria-label={t.heroSection.accessibility.exploreButton}
              >
              ...
              <button
                ...
                aria-label={t.heroSection.accessibility.viewAllButton}
              >
              ...
              {destinations.map((dest, index) => {
                ...
                return (
                  <div
                    ...
                    aria-label={t.heroSection.accessibility.destinationImage.replace(
                      "{name}",
                      dest.name
                    )}
                  >
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-150 w-2/5 h-2/5">
                ...
                >
                  ...
                  <img
                    ...
                    alt={t.heroSection.accessibility.featuredDestination}
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 flex space-x-3">
                {destinations.map((_, index) => (
                  <button
                    ...
                    onClick={() => handleSelectImage(index)}
                    aria-label={t.heroSection.accessibility.carouselControl.replace(
                      "{number}",
                      index + 1
                    )}
                  ></button>
