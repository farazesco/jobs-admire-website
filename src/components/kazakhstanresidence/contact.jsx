...
import enTranslations from '../../../public/locales/en/kaza3.json';
import trTranslations from '../../../public/locales/tr/kaza3.json';
import frTranslations from '../../../public/locales/fr/kaza3.json';
import deTranslations from '../../../public/locales/de/kaza3.json';
import arTranslations from '../../../public/locales/ar/kaza3.json';
import ruTranslations from '../../../public/locales/ru/kaza3.json';
import faTranslations from '../../../public/locales/fa/kaza3.json';
...
const ContactsSection = () => {
  ...
  const contacts = [
    {
      id: 1,
      country: t.contacts.location1.country,
      city: t.contacts.location1.city,
      address: t.contacts.location1.address,
      phone: "+90 242 123 4567",
      email: "antalya@uniadmire.com",
      hours: t.contacts.location1.hours,
      icon: Building,
    ...
    {
      id: 2,
      country: t.contacts.location2.country,
      city: t.contacts.location2.city,
      address: t.contacts.location2.address,
      phone: "+92 21 3456 7890",
      email: "karachi@uniadmire.com", 
      hours: t.contacts.location2.hours,
      icon: Building,
    ...
    {
      id: 3,
      country: t.contacts.location3.country,
      city: t.contacts.location3.city,
      address: t.contacts.location3.address,
      phone: "+994 12 345 6789",
      email: "baku@uniadmire.com",
      hours: t.contacts.location3.hours,
      icon: Building,
