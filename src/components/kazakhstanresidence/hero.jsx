...
import enTranslations from "../../../public/locales/en/kaza4.json";
import trTranslations from "../../../public/locales/tr/kaza4.json";
import frTranslations from "../../../public/locales/fr/kaza4.json";
import deTranslations from "../../../public/locales/de/kaza4.json";
import arTranslations from "../../../public/locales/ar/kaza4.json";
import ruTranslations from "../../../public/locales/ru/kaza4.json";
import faTranslations from "../../../public/locales/fa/kaza4.json";
import { createInquiry } from "@/utils/crmUtils";

const KazakhstanHeroSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await createInquiry({
      name: formData.name,
      interested_service: "Kazakhstan Residence Permit",
  ...
  return (
    <div className="bg-gradient-to-br pt-[186px] xs:pt-[166px] lg:pt-[172px] pb-[50px] from-sky-50 via-blue-50 to-cyan-50 relative overflow-hidden">
      ...
      {/* Kazakhstan Landmarks SVG Background */}
        ...
        <svg viewBox="0 0 1400 600" className="w-full h-full">
          ...
          <g transform="translate(200,100)">
            <rect
              ...
              rx="5"
            />
            <circle cx="50" cy="180" r="30" fill="#0ea5e9" opacity="0.3" />
            <circle cx="50" cy="180" r="20" fill="#0ea5e9" opacity="0.4" />
            <circle cx="50" cy="180" r="10" fill="#0ea5e9" opacity="0.5" />
            <rect
              x="35"
              y="150"
              width="30"
          ...
          <g transform="translate(400,120)">
            ...
            <rect
              ...
              rx="17"
            />
            <circle cx="122" cy="15" r="10" fill="#0ea5e9" opacity="0.4" />
          </g>

          <g transform="translate(650,220)">
            <circle cx="75" cy="100" r="60" fill="#0ea5e9" opacity="0.2" />
            <path d="M75,40 L125,100 L75,100 Z" fill="#0ea5e9" opacity="0.3" />
            <path d="M75,40 L25,100 L75,100 Z" fill="#0ea5e9" opacity="0.3" />
            <rect
              x="70"
              y="90"
              width="10"
              ...
              rx="5"
            />
            <circle cx="75" cy="35" r="8" fill="#0ea5e9" opacity="0.5" />
          </g>

          <g transform="translate(850,150)">
            <path d="M0,250 Q75,50 150,250 Z" fill="url(#buildingGrad)" />
            <rect
              x="70"
              y="240"
              width="10"
              ...
              opacity="0.3"
            />
            <circle cx="75" cy="60" r="12" fill="#0ea5e9" opacity="0.4" />
            <path d="M75,60 L90,80 L60,80 Z" fill="#0ea5e9" opacity="0.35" />
          </g>
...
export default KazakhstanHeroSection;
