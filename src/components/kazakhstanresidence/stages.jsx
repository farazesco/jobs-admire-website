...
import enTranslations from '../../../public/locales/en/kaza5.json';
import trTranslations from '../../../public/locales/tr/kaza5.json';
import frTranslations from '../../../public/locales/fr/kaza5.json';
import deTranslations from '../../../public/locales/de/kaza5.json';
import arTranslations from '../../../public/locales/ar/kaza5.json';
import ruTranslations from '../../../public/locales/ru/kaza5.json';
import faTranslations from '../../../public/locales/fa/kaza5.json';

const KazakhstanResidenceProcess = () => {
  ...
  const images = [
    {
      src: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=500&h=400&fit=crop&crop=center",
      alt: t.images.image1.alt,
      location: t.images.image1.location,
      description: t.images.image1.description
    },
    {
      src: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500&h=400&fit=crop&crop=center",
      alt: t.images.image2.alt,
      location: t.images.image2.location,
      description: t.images.image2.description
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFvy60rU4VO1-LnlvY3f7spgPiR9INuX2Www&s",
      alt: t.images.image3.alt,
      location: t.images.image3.location,
      description: t.images.image3.description
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2zkH5-7CtlvxDc-tozw9FOkKiSRJqrUEpoA&s",
      alt: t.images.image4.alt,
      location: t.images.image4.location,
      description: t.images.image4.description
    }
  ];
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-white/90 backdrop-blur-lg rounded-xl p-3 shadow-lg border border-white/50">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sky-800 font-semibold text-xs">{t.floatingBadge.text}</span>
              </div>
            </div>
          </div>
...
export default KazakhstanResidenceProcess;