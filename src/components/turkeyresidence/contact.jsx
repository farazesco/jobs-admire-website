...
import enTranslations from '../../../public/locales/en/turkeycontact.json';
import trTranslations from '../../../public/locales/tr/turkeycontact.json';
import frTranslations from '../../../public/locales/fr/turkeycontact.json';
import deTranslations from '../../../public/locales/de/turkeycontact.json';
import arTranslations from '../../../public/locales/ar/turkeycontact.json';
import ruTranslations from '../../../public/locales/ru/turkeycontact.json';
import faTranslations from '../../../public/locales/fa/turkeycontact.json';
  ...
  const contacts = [
    {
      ...
      phone: t.locations.turkey.phone,
      email: t.locations.turkey.email,
    ...
    },
    {
      ...
      phone: t.locations.pakistan.phone,
      email: t.locations.pakistan.email, 
    ...
    },
    {
      ...
      phone: t.locations.azerbaijan.phone,
      email: t.locations.azerbaijan.email,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border border-white/50 shadow-xl">
              ...
              <a 
                href={`mailto:${t.generalInquiries.email}`} 
